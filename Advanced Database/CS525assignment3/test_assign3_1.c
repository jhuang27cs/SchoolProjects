...
//        printf("updateRecord %i\n",*(r->data));
//        printf("updateRecord %s\n",(r->data + 4));
//        printf("updateRecord %i\n",*(r->data + 8));
    }
...
//        printf("fromTestRecord %i\n",*(r->data));
//        printf("fromTestRecord %s\n",(r->data + 4));
//        printf("fromTestRecord %i\n",*(r->data + 8));
        TEST_CHECK(insertRecord(table,r));
        rids[i] = r->id;
//        printf("page %i, slot %i", r->id.page, r->id.slot);
    }
    TEST_CHECK(closeTable(table));
    TEST_CHECK(openTable(table, "test_table_t"));
    // retrieve records from the table and compare to expected final stage
...
//         printf("getRecord %s\n",(r->data + 4));
//         printf("getRecord %i\n",*(r->data + 8));
        t=fromTestRecord(schema, realInserts[i]);
//        printf("TestRecord %i\n",*(t->data));
//        printf("TestRecord %s\n",(t->data + 4));
//        printf("TestRecord %i\n",*(t->data + 8));
        ASSERT_EQUALS_RECORDS(t, r, schema, "compare records");
    }
