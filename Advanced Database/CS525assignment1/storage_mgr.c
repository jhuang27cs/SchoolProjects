...
RC readB (int pageNum, SM_FileHandle *fHandle, SM_PageHandle memPage){
...
/*
 * Read the first block by providing the pageNum argument as 0 to the readB function.
 */
RC readFirstBlock (SM_FileHandle *fHandle, SM_PageHandle memPage){
    return readB(0, fHandle, memPage);
}

/*
 * Read the previous block by providing the pageNum argument as curPagePos-1 to the readB function.
 */
RC readPreviousBlock (SM_FileHandle *fHandle, SM_PageHandle memPage){
    return readB(fHandle->curPagePos-1, fHandle, memPage);
}

/*
 * Read the current block by providing the pageNum argument as curPagePos to the readB function.
 */
RC readCurrentBlock (SM_FileHandle *fHandle, SM_PageHandle memPage){
    return readB(fHandle->curPagePos, fHandle, memPage);
}

/*
 *Read the next block by providing the pageNum argument as curPagePos+1 to the readB function.
 */
...
/*
 *Read the last block by providing the pageNum argument as totalNumPages to the readB function.
 */
RC readLastBlock (SM_FileHandle *fHandle, SM_PageHandle memPage){
    return readB(fHandle->totalNumPages, fHandle, memPage);
}
